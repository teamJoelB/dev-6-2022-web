<%-- 
    Document   : menu
    Created on : 6 oct. 2022, 15:24:22
    Author     : joelg
--%>
...
<html>
    ...
    <body>
        <div>
            <ul class="nav peach-gradient lighten-3 py-4 mb-4 font-weight-bold z-depth-1 w-100 nav-fill">
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link white-text" href="">Autres</a>
                </li>
            </ul>
        </div>
    </body>
